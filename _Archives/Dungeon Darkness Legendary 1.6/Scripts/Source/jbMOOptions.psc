...
Function doUpdate()
	...
	if version < 1.51
		jbUtils.DebugTrace("Updating to version 1.51")
		Opt_disableAI = true
		version = 1.51
	endIf
...
bool Property disableAI

	Function Set(bool value)
		Opt_disableAI = value
		jbUtils.DebugTrace("disableAI set to "+Opt_disableAI)
	endFunction
	
	bool Function Get()
		return Opt_disableAI
	EndFunction
...
Function dumpOptions()
	...
	debug.trace("disableAI: "+Opt_disableAI)
