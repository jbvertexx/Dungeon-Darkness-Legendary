...
function LoadforRun(jbMOMainQS akMainQS, Cell akCell, int akRunType, bool akDisableAI)

	thread01.loadVars(akMainQS,akCell,akRunType,akDisableAI)
	thread02.loadVars(akMainQS,akCell,akRunType,akDisableAI)
	thread03.loadVars(akMainQS,akCell,akRunType,akDisableAI)
	thread04.loadVars(akMainQS,akCell,akRunType,akDisableAI)
	thread05.loadVars(akMainQS,akCell,akRunType,akDisableAI)
	thread06.loadVars(akMainQS,akCell,akRunType,akDisableAI)
	thread07.loadVars(akMainQS,akCell,akRunType,akDisableAI)
	thread08.loadVars(akMainQS,akCell,akRunType,akDisableAI)
	thread09.loadVars(akMainQS,akCell,akRunType,akDisableAI)
	thread10.loadVars(akMainQS,akCell,akRunType,akDisableAI)
	thread11.loadVars(akMainQS,akCell,akRunType,akDisableAI)
	thread12.loadVars(akMainQS,akCell,akRunType,akDisableAI)
	thread13.loadVars(akMainQS,akCell,akRunType,akDisableAI)
	thread14.loadVars(akMainQS,akCell,akRunType,akDisableAI)
	thread15.loadVars(akMainQS,akCell,akRunType,akDisableAI)
	thread16.loadVars(akMainQS,akCell,akRunType,akDisableAI)
	thread17.loadVars(akMainQS,akCell,akRunType,akDisableAI)
	thread18.loadVars(akMainQS,akCell,akRunType,akDisableAI)
	thread19.loadVars(akMainQS,akCell,akRunType,akDisableAI)
	thread20.loadVars(akMainQS,akCell,akRunType,akDisableAI)
